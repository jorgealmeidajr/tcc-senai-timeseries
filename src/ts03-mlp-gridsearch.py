...
OUTPUT_M: str = 'output\\ts03\\ts03-m-mlp.csv'
OUTPUT_M2: str = 'output\\ts03\\ts03-m2-mlp.csv'

# carrego a serie temporal mensal com duas amostras
df_monthly2 = data.load_timeseries03_monthly2()

# carrego a serie temporal mensal
df_monthly = data.load_timeseries03_monthly()


def main():
  print('\nMLP: Busca pela melhor REDE NEURAL - Serie Temporal TS03')
